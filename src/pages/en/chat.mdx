  ...
  cards={[
    {
      ...
      label: "Discord 서버 들어가기",
      href: "https://discord.gg/sUvF7PAgNd",
    },
    {
      imgSrc: matrixlogo.src,
      label: "Matrix 스페이스 들어가기 (#loco-kr:ubuntu.com)",
      href: "https://matrix.to/#/#loco-kr:ubuntu.com",
    },
    {
      imgSrc: liberachatlogo.src,
      label: "IRC (Libera.chat, Kiwi IRC 로 바로 접속)",
      href: "http://kiwiirc.com/client/irc.libera.chat/ubuntu-kr",
    },
  ]}>
  # 익숙한 채팅 서비스로 참여하세요
  우리 커뮤니티에서는 공식 채팅 채널을 Matrix, Discord, IRC 로 제공하고 있으며, 셋중 편한 것으로 선택하셔서 참여하실 수 있습니다.

  - Matrix: 국내뿐만 아니라 전세계 우분투 커뮤니티에서 공식적으로 사용하는 주요 커뮤니케이션 수단입니다.
  - Discord: 최근들어 다양한 오픈소스/IT 커뮤니티에서도 활용하는 메신저로, 이미 Discord를 사용 중이시라면 쉽게 채팅에 참여 가능합니다.
  - IRC: 기존에 우분투 커뮤니티에서 사용하던 채팅 수단입니다. 최근 Matrix 로 이동 중이여서 Matrix 이용을 권장합니다.
  </HeroGridOnRight>
